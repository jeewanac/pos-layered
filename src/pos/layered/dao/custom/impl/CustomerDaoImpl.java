...
public class CustomerDaoImpl implements CustomerDao{
    ...
    public boolean add(CustomerEntity t) throws Exception {
        return CrudUtil.executeUpdata("INSERT INTO Customer VALUES(?,?,?,?,?,?,?,?,?)", 
                t.getId(),
                t.getTitle(),
                t.getName(),
                t.getDob(),
    ...
    public boolean update(CustomerEntity t) throws Exception {
        return CrudUtil.executeUpdata("UPDATE Customer SET CustTitle =?, CustName = ?, DOB =?, salary = ?, CustAddress = ?, City = ?, Province = ?, PostalCode =? WHERE CustID = ?", 
                t.getTitle(),
                t.getName(),
                t.getDob(),
                t.getSalary(),
    ...
    public boolean delete(String id) throws Exception {
         return CrudUtil.executeUpdata("DELETE FROM customer WHERE CustID = ?", 
                id);
    }
